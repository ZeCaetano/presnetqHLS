...
//				tmp_data.range(7,4) = (quant_act)image_in[(i*INPUT1_MEM_SIZE)+(((j+1)*X1*Y1) + t)];
//				tmp_data.range(11,8) = (quant_act)image_in[(i*INPUT1_MEM_SIZE)+(((j+2)*X1*Y1) + t)];
//				tmp_data.range(15,12) = (quant_act)image_in[(i*INPUT1_MEM_SIZE)+(((j+3)*X1*Y1) + t)];
//				tmp_data.range(19,16) = (quant_act)image_in[(i*INPUT1_MEM_SIZE)+(((j+4)*X1*Y1) + t)];
//				tmp_data.range(23,20) = (quant_act)image_in[(i*INPUT1_MEM_SIZE)+(((j+5)*X1*Y1) + t)];
//				tmp_data.range(27,24) = (quant_act)image_in[(i*INPUT1_MEM_SIZE)+(((j+6)*X1*Y1) + t)];
//				tmp_data.range(31,28) = (quant_act)image_in[(i*INPUT1_MEM_SIZE)+(((j+7)*X1*Y1) + t)];
//				vin.data = tmp_data;
